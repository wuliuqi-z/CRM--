...
<script type="text/javascript">
	$(function(){
		...
		$("#saveCreateBtn").click(function (){
			...
			let expectedDate	=	$.trim($("#create-expectedDate").val())
			let customerName	=	$.trim($("#create-customerName").val())
			let stage			=			$.trim($("#create-stage").val())
			let type			=			$.trim($("#create-type").val())
			let source			=			$.trim($("#create-source").val())
			let activityId		=		$.trim($("#create-activityId").attr("name"))
			let contactsId		=		$.trim($("#create-contactsId").attr("name"))
			...
			$.ajax({
				url:'workbench//transaction/savaCreateTran.do',
				data:{
					owner:owner,
					money:money,
					name:name,
		...
		$("#create-stage").change(function(){
			//alert($(this).find("option:selected").text())//find()函数表示在这个标签下找到他的某一个具体的子标签
			//alert($(this).children("option:selected").text())
			let stage = $(this).children("option:selected").text();
			$.ajax({
				beforeSend:function(){
					if(stage==null||stage==""){
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activityId" value="测试002" name="366f37c86c664138abab983e4727721a">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsId" value="陈旭" name="f72337743a8448159dd6fdf4d98b58e5">
			</div>
		</div>
