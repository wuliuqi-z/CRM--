...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<c:forEach items="${stage}" var="s">
			<c:if test="${flag==0&&s.value!=transaction.stage}">
			...
			<c:if test="${s.value==transaction.stage}">
				<%
			...
			<c:if test="${flag==1&&s.value!=transaction.stage}">
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 30px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${possible}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
	...
	<div style="position: relative; top: 100px; left: 40px;">
		...
		<c:forEach items="${transactionRemarks}" var="r">
			<div class="remarkDiv" style="height: 60px;" id="div_${r.id}">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					<h5>${r.noteContent}</h5>
					<font color="gray">交易</font> <font color="gray">-</font> <b>${transaction.name}</b> <small style="color: gray;">${r.editFlag=='0'?r.createTime:r.editTime} 由${r.editFlag=='0'?r.createBy:r.editBy}${r.editFlag=='0'?'创建':'修改'}</small>
					<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
						<a class="myHref" href="javascript:void(0);"  remark-id="${r.id}"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<a class="myHref" href="javascript:void(0);" remark-id="${r.id}"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
					</div>
				</div>
			</div>
		</c:forEach>
		...
		<div style="position: relative; top: 100px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table id="activityTable" class="table table-hover" style="width: 900px;">
					...
					<tbody>
					<c:forEach items="${transactionHistories}" var="th">
						<tr>
							<td>${th.stage}</td>
							<td>${th.money}</td>
